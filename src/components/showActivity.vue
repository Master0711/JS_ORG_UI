<template>
  <div style="width: 850px;height: 500px;padding:0px 10px;">
    ...
    overflow-x: hidden;height:460px;">
      ...
      <div style="margin-left: 10px;" v-for="item in registering" v-show="show == 2">
        <el-row :gutter="12">
          <el-col :span="8">
            <el-card shadow="hover" style="width: 350px;height: 260px;border: white;cursor: pointer;">
              <div style="width: 100%;height: 100%;">
      ...
      <div style="margin-left: 10px;" v-for="item in registering" v-show="show == 3">
        <el-row :gutter="12">
          <el-col :span="8">
            <el-card shadow="hover" style="width: 350px;height: 260px;border: white;cursor: pointer;">
              <div style="width: 100%;height: 100%;">
    ...
    <div id="regwindow" style="padding: 10px;display: none;">
      <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
        ...
        <div style="text-align: center;display: flex;margin-top: 15px;width: 85%;padding-left: 12px;">
          ...
          <span style="line-height: 20px;max-width: 300px;margin-left: 10px;font-size: 13px;font-family: 'Arial','STKaiti','黑体','宋体',sans-serif;">
